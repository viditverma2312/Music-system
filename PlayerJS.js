...
function loadTrack(track_index) {
  ...
  image.style.backgroundImage = "url(" + track_list[track_index].image + ")";
...
function playTrack() {
  curr_track.play();
  isPlaying = true;
  play_pause.innerHTML = '<i class="fa fa-pause-circle fa-4x"></i>';
}

function pauseTrack() {
  curr_track.pause();
  isPlaying = false;
  play_pause.innerHTML = '<i class="fa fa-play-circle fa-4x"></i>';;
}
